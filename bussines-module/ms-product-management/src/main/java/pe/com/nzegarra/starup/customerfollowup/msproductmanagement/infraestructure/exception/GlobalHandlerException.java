package pe.com.nzegarra.starup.customerfollowup.msproductmanagement.infraestructure.exception;
...
import pe.com.nzegarra.starup.customerfollowup.msproductmanagement.core.exception.GlobalNotFoundException;
		...
		if(ex instanceof GlobalNotFoundException) {
			response = GeneralResponse.builder()
					.response(MessageResponse.builder()
		        		.code(ProductConstants.CODE_ERROR)
			...
			response = GeneralResponse.builder()
					.response(MessageResponse.builder()
		        		.code(ProductConstants.CODE_ERROR_NO_CONTROLADO)
