package pe.com.nzegarra.starup.customerfollowup.mscustomermanagement.infraestructure.exception;
...
import pe.com.nzegarra.starup.customerfollowup.mscustomermanagement.core.exception.GlobalNotFoundException;
		...
		if(ex instanceof GlobalNotFoundException) {
			response = GeneralResponse.builder()
					.response(MessageResponse.builder()
		        		.code(CustomerConstants.CODE_ERROR)
			...
			response = GeneralResponse.builder()
					.response(MessageResponse.builder()
		        		.code(CustomerConstants.CODE_ERROR_NO_CONTROLADO)
